  ...
  const connectToDevice = async () => {
    ...
    try {
      ...
      if (!isEnabled) {
        ...
        try { await BleClient.requestEnabled(); } catch(e) {}
      ...
      console.error(error);
      addLog(`Status: ${error.message || 'Scan stopped'}`);
    } finally {
      setIsConnecting(false);
    }
  };
        ...
        <div className="p-8 pb-4 flex items-center justify-between relative z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 uppercase tracking-[0.2em] font-semibold">Universal Controller</p>
            </div>
          </div>
          <button 
